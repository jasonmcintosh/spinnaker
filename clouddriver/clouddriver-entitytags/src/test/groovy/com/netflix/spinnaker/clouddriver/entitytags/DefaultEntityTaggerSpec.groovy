...
package com.netflix.spinnaker.clouddriver.entitytags

import com.netflix.spinnaker.clouddriver.data.task.DefaultTask
import com.netflix.spinnaker.clouddriver.data.task.Task
import com.netflix.spinnaker.clouddriver.data.task.TaskRepository
import com.netflix.spinnaker.clouddriver.entitytags.converters.DeleteEntityTagsAtomicOperationConverter
import com.netflix.spinnaker.clouddriver.orchestration.AtomicOperation
import spock.lang.Specification
import spock.lang.Unroll

class DefaultEntityTaggerSpec extends Specification {
  void "should construct valid UpsertEntityTagsDescription"() {
    when:
    def categorizedDescription = DefaultEntityTagger.upsertCategorizedEntityTagsDescription(
      DefaultEntityTagger.ALERT_TYPE,
      DefaultEntityTagger.ALERT_KEY_PREFIX,
      "myCloudProvider",
      "100",
      "us-east-1",
      "mycategory",
    ...
    when:
    def description = DefaultEntityTagger.upsertEntityTagsDescription(
      "scaling_policies",
      "myCloudProvider",
      "100",
      "us-east-1",
  ...
  void "should construct valid DeleteEntityTagsDescription"() {
    when:
    def description = DefaultEntityTagger.deleteEntityTagsDescription(
  ...
  void "should only mutate threadLocalTask if null"() {
    ...
    def serverGroupTagger = new DefaultEntityTagger(null, null, deleteConverter) {
      @Override
    ...
    then:
    threadLocalTask.id == "DefaultEntityTagger"
