...
import com.netflix.spinnaker.clouddriver.entitytags.ops.BulkUpsertEntityTagsAtomicOperation;
...
public class BulkUpsertEntityTagsAtomicOperationConverter
  ...
  public AtomicOperation convertOperation(Map input) {
    return new BulkUpsertEntityTagsAtomicOperation(
        accountCredentialsProvider, entityTagsProvider, this.convertDescription(input));
  }
