...
import com.netflix.spinnaker.clouddriver.entitytags.DefaultEntityTagger;
...
@Configuration
@ConditionalOnBean(EntityTagsProvider.class)
@ComponentScan("com.netflix.spinnaker.clouddriver.entitytags")
public class EntityTagsConfiguration {

  @Bean
  public DefaultEntityTagger defaultEntityTagger(
    ...
    return new DefaultEntityTagger(
        entityTagsProvider,
