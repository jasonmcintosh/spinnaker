...
public class DefaultEntityTagger implements EntityTagger {
  private static final Logger log = LoggerFactory.getLogger(DefaultEntityTagger.class);
    ...
    try {
      TaskRepository.threadLocalTask.set(
          Optional.ofNullable(originalTask)
              .orElse(new DefaultTask(DefaultEntityTagger.class.getSimpleName())));
      run(operation);
    } finally {
  ...
  static UpsertEntityTagsDescription upsertCategorizedEntityTagsDescription(
      String type,
      String prefix,
      String cloudProvider,
      String accountId,
  ...
  static UpsertEntityTagsDescription upsertEntityTagsDescription(
      String name,
      String cloudProvider,
      String accountId,
      String region,
  ...
  static DeleteEntityTagsDescription deleteEntityTagsDescription(
      String cloudProvider,
      String accountId,
      String region,
      String entityType,
