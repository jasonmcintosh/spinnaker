...
import static com.netflix.spinnaker.clouddriver.entitytags.ops.BulkUpsertEntityTagsAtomicOperation.entityRefId;
...
public class UpsertEntityTagsAtomicOperation implements AtomicOperation<Void> {
  ...
  public Void operate(List priorOutputs) {
    ...
    new BulkUpsertEntityTagsAtomicOperation(
            accountCredentialsProvider, entityTagsProvider, bulkDescription)
