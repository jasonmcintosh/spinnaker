...
import com.netflix.spinnaker.clouddriver.entitytags.ops.DeleteEntityTagsAtomicOperation;
...
public class DeleteEntityTagsAtomicOperationConverter
  ...
  public DeleteEntityTagsAtomicOperationConverter(
      ObjectMapper objectMapper, EntityTagsProvider entityTagsProvider) {
    this.objectMapper =
        objectMapper
            .copy()
  ...
  public AtomicOperation buildOperation(DeleteEntityTagsDescription description) {
    return new DeleteEntityTagsAtomicOperation(entityTagsProvider, description);
  }
